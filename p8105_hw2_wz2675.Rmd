...
In this part, I import, clean, and organize the data for Mr. Trash Wheel from the excel file inside the excel file `202207 Trash Wheel Collection Data.xlsx`.
```{r}
mr_trash_wheel =
...
Calculating the cigarette butts collected by Gwynnda Trash Wheel in July of 2021
```{r}
july_2021_cigbutts = 
  gwynnda_trash_wheel |> 
